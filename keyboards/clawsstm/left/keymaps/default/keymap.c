...
// https://beta.docs.qmk.fm/features/keycodes_basic
		   ...
		   LALT(KC_TAB),   KC_ESC,   KC_GRV,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   KC_KP_PLUS,   KC_KP_ASTERISK, \
		   MEH(KC_QUOT),   LCTL(KC_S),   KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_ENT,  KC_PSLS, \
		   LALT(KC_TAB),   LCTL(KC_V),   KC_CAPS,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    MO(_FN1),   KC_BSLS, \
		   LALT(KC_TAB),   LCTL(KC_C),  KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_SPC, KC_BSPACE, \
		   MO(_FN1),   KC_LCTRL,  KC_LCTRL,   KC_LALT,   KC_LALT, KC_UP,   KC_RSFT, KC_DOWN, KC_NO,    KC_NO \
		),
	[_FN1] = LAYOUT(
		   ...
		   MOTOR3,   KC_VOLU,   KC_QUOT,  KC_SCLN,    KC_L,    KC_K,    KC_J,    KC_H,    MO(_FN1),   KC_SPC, \
		   ...
		   KC_PAUSE,   KC_ENT,   KC_QUOT,  KC_SCLN,    KC_L,    KC_K,    KC_J,    KC_H,    MO(_FN1),   KC_PAUSE, \
	...
	[_FN1] = LAYOUT(
		   ...
		   MOTOR3,   KC_MS_WH_UP,   KC_CAPS,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    MO(_FN1),   KC_BSLS, \
